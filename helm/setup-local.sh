...
docker build -f service/Dockerfile.api -t codeapi-api:latest ./service

echo "Building codeapi-file-server..."
docker build -f service/Dockerfile -t codeapi-file-server:latest ./service

echo "Building codeapi-tool-call-server..."
docker build -f service/Dockerfile.tool-call-server -t codeapi-tool-call-server:latest ./service
