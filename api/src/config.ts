...
export const config = {
  ...
  npm_tarball_max_bytes: safeInt(process.env.CODEAPI_NPM_TARBALL_MAX_BYTES, 32 * 1024 * 1024),
  npm_unit_max_unpacked_bytes: safeInt(process.env.SANDBOX_NPM_UNIT_MAX_UNPACKED_BYTES, 64 * 1024 * 1024),
  npm_unit_max_kept_bytes: safeInt(process.env.SANDBOX_NPM_UNIT_MAX_KEPT_BYTES, 32 * 1024 * 1024),
  npm_unit_max_file_bytes: safeInt(process.env.SANDBOX_NPM_UNIT_MAX_FILE_BYTES, 8 * 1024 * 1024),
  npm_unit_max_entries: safeInt(process.env.SANDBOX_NPM_UNIT_MAX_ENTRIES, 50_000),
  npm_unit_max_response_bytes: safeInt(process.env.SANDBOX_NPM_UNIT_MAX_RESPONSE_BYTES, 32 * 1024 * 1024),
  npm_unit_run_timeout: safeInt(process.env.SANDBOX_NPM_UNIT_RUN_TIMEOUT, 15_000),
  npm_unit_cpu_time: safeInt(process.env.SANDBOX_NPM_UNIT_CPU_TIME, 15_000),
  npm_unit_memory_limit: safeInt(process.env.SANDBOX_NPM_UNIT_MEMORY_LIMIT, 384 * 1024 * 1024),
  npm_unit_fetch_timeout: safeInt(process.env.SANDBOX_NPM_UNIT_FETCH_TIMEOUT, 20_000),
